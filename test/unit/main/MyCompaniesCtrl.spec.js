...
describe('My Companies', function() {
    ...
    describe('when the user is not logged in', function() {
        ...
        beforeEach(inject(function($rootScope, $controller, Site, _$httpBackend_, $location) {
            ...
            site = Site;
            location = $location;
            ctrl = $controller('MyCompaniesCtrl', {$scope: scope, Site: site, $location: location});
        }));
    ...
    describe('when the user is logged in', function() {
        ...
        beforeEach(inject(function($rootScope, $controller, Site, _$httpBackend_, $location) {
            ...
            Site.user.links.myCompanies = "dumblink";
            site = Site;
            location = $location;
            ctrl = $controller('MyCompaniesCtrl', {$scope: scope, Site: site, $location: location});
        }));
        ...
        it('should set initial Site attributes (when the user is logged in)', function() {
            ...
            expect(site.page).toEqual("myCompanies");
            expect(site.title).toEqual("My Companies");
        });
        
        it('should pull a user\'s companies', function() {
